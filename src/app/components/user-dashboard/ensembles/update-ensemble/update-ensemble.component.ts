...
@Component({
  selector: 'app-update-ensemble',
  templateUrl: './update-ensemble.component.html',
  styleUrls: ['./update-ensemble.component.css']
})
export class UpdateEnsembleComponent implements OnInit {
  userId!:string
